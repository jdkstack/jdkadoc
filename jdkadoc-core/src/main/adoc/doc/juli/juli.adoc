...
[source,xml]
----
include::{docdir}/jdkadoc-core/pom.xml[]
----
...
.Logging.
----
include::{docdir}/jdkadoc-examples/src/main/resources/logging.properties[]
----

[source]
examples
----
include::{docdir}/jdkadoc-examples/src/main/java/org/jdkstack/jdkadoc/examples/Examples.java[]
----
